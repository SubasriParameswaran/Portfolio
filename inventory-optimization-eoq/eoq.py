...
def reorder_point(avg_daily_demand: float, lead_time_days: int, demand_std_daily: float, service_z: float = 1.65):
...
if __name__ == "__main__":
    ...
    q = eoq(sample)
    rop = reorder_point(avg_daily_demand=10000/365, lead_time_days=sample.lead_time_days, demand_std_daily=sample.demand_std_daily)
